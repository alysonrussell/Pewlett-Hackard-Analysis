...
-- Drop table so that we can recreate with correct columns.
...
-- Use aliases to do the same thing as above.
SELECT ri.emp_no,
	ri.first_name,
ri.last_name,
	de.to_date 
...
-- Create a new table containing only current employees who are retirement-eligible.
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
de.to_date
